    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f8f4e9] to-[#f0e6d2] flex items-center justify-center p-4">
      <div className="w-full max-w-6xl flex flex-col lg:flex-row gap-8 items-center">
        ...
        >          <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-[#e5e5e5]">
            ...
            <div className="bg-[#102542] p-6 text-center relative overflow-hidden">
              <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/food.png')] opacity-10"></div>
              <div className="relative">
                <h2 className="text-2xl font-bold text-white font-serif tracking-wide">Join SultanMabi</h2>
                <p className="text-white/90 mt-2 text-sm">Create your account to access quality meat selections</p>
              </div>
            </div>
