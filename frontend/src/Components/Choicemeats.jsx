// src/Components/Choicemeats.jsx
...
const products = [
  { id: 201, name: "Pork Mince 1kg", image: "/images/pork_mince.jpg", price: 600 },
  { id: 202, name: "Beef Mince 1kg", image: "/images/beef_mince.jpg", price: 620 },
  { id: 203, name: "Chicken Fillet 1kg", image: "/images/chicken_fillet.jpg", price: 500 },
  { id: 204, name: "Tilapia Fillet 500g", image: "/images/tilapia.jpg", price: 680 },
  { id: 205, name: "Beef Stir-fry 500g", image: "/images/beef_stirfry.jpg", price: 720 },
  // … add more up to 15+
];
...
export default function ChoiceMeats() {
  ...
  return (
    <section className="py-12 bg-snow relative font-sans">
      <h2 className="text-3xl font-bold text-center text-madder mb-6">Choice Meats Collection</h2>
